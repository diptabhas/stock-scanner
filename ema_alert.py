...
WATCHLIST = """ 
AAOI, AAON, ACLS, ADI, ADM, AEHR, AGX, AIIXY, AKAAF, AKAM, ALAB, AMAT, AMD, ARM, ARMK, ARW, ASAAF, ASML, ASMLF, ASTS, AXSM, AXTI, BKGM, BTSG, BTSGU, CAT, CBOE, CDNTF, CELC, CIEN, CMPR, COHR, CPRX, CRCL, CRDO, CRWD, CSCO, CTVA, CVE, DDOG, DELL, DOCN, DVA, EBAY, FFIV, FIX, FLEX, FOTB, FTNT, FUWAF, FUWAY, GFS, GLAPY, GLNG, GLW, HPE, HRIBF, HUM, HUT, HWM, IBIDF, ICHR, IESFY, INTC, IONQ, JAZZ, JBL, KEYS, KGS, KLIC, KRYS, KXHCF, LAMR, LFUS, LNTH, LRCX, LSCC, MCEM, MKSI, MOD, MPC, MRVL, MTRN, MTSI, MU, MYRG, NBIS, NHC, NOVT, NRKBF, NTAP, NVDA, NVT, NWPX, NXPRF, ON, OUT, PANW, PLAB, PNRG, PRYMF, PWR, Q, QCOM, QRVO, RKLB, RMBS, RPRX, SANM, SCPJ, SDRL, SEI, SESMF, SEZL, SFL, SHWDF, SHWDY, SIMO, SITM, SLOIF, SLOIY, SMTC, SNDK, SOLS, SOXL, SSLLF, STRL, STX, SYNA, TOELF, TQQQ, TRGP, TSEM, TTMI, TWLO, TXN, TYOYY, ULS, VCX, VIAV, VPG, VRSN, WDC
"""
